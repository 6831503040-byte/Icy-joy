        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button 
                onClick={onShopNow}
                className="px-10 py-5 bg-pink-600 text-white text-xl font-bold rounded-full hover:bg-pink-700 shadow-xl"
              >
                Order Now 🍦
              </button>
              <button 
                onClick={onTryAI}
                className="px-10 py-5 bg-blue-500 text-white text-xl font-bold rounded-full hover:bg-blue-600 shadow-xl"
              >
                AI Flavor Finder ✨
              </button>
            </div>
          ...
          <div className="relative">
            <img 
              ...
              className="rounded-3xl shadow-2xl border-[12px] border-white"
            />
            {/* Decorative Elements */}
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
            {[
              ...
              <div key={idx} className="p-10 rounded-3xl bg-pink-50 hover:bg-pink-100 group border-2 border-transparent hover:border-pink-200 flex flex-col items-center">
